...
Media Queries pour le responsive design (mobile, tablette, desktop).
Transitions et effets :hover pour l’interactivité.
...
Au départ, nous avons eu des difficultés pour structurer la page d’accueil :
il fallait construire un squelette HTML clair et réutilisable (header, footer, variables CSS globales).
